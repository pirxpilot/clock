...
test('should consider all times between 0:00 and 23:59 as valid if no min/max specified', function(assert) {
  assert.plan(3);
...
test('should consider all times outside of 0:00 and 23:59 as invalid', function(assert) {
  assert.plan(2);
...
test('should consider hours inside of the range as valid', function(assert) {
  assert.plan(5);
...
test('should consider hours outside of the range as valid, when reversed', function(assert) {
  assert.plan(5);
...
test('should consider minutes inside of the range as valid', function(assert) {
  assert.plan(8);
...
test('should consider minutes outside of the range as valid, when reversed', function(assert) {
  assert.plan(8);
...
test('should restrict time properly', function(assert) {
  assert.plan(8);
